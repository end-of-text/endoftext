<article class="prose lg:prose-xl m-10 w-screen">
	...
	<ul>
		...
		<li>
			<p>
				...
				or &quot;Our&quot; in this Agreement) refers to endoftext.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				<strong>Website</strong> refers to endoftext, accessible from
				<a href="https://endoftext.app" rel="external nofollow noopener" target="_blank"
					>https://endoftext.app</a
				>
			</p>
		</li>
		<li>
	...
	<ul>
		<li>By email: hello@endoftext.app</li>
	</ul>
</article>
